...
public class Enigma06 extends Enigma {
	...
	private void initialize() {
		...
		txtpnIpxV.setText(
				"Determine se a interpreta\u00E7\u00E3o da f\u00F3rmula a seguir \u00E9 verdadeira ou falsa, sendo que:\r\nI[c1] = 5\r\nI[c2] = 2\r\nI[c3] = 1\r\nI[f1(x,y)] = x + y \r\nI[f2(x)] = x2\r\nI[p(x)] = V, se (x \u00E9 \u00EDmpar)\r\nU = conjunto dos n\u00FAmeros naturais\r\n");
